...
# There are two commas that separate three key-value pairs. All keys are strings and all values are strings too.
...
try_this = {"1": "first", 1: "one", 1.1: "uno"}
print(try_this)
